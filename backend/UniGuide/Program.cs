...
using System.Text;
using UniGuide.Code;
using UniGuide.Code.ExtensionMethods;
...
builder.Services.AddDbContext<UniGuideContext>(options =>
{
...
builder.Services.AddUniGuideBusinessLogic();

builder.Services.AddUniGuideCurrentUser();
